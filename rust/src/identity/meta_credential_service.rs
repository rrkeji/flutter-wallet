...
use keys_idns_api::idns::system::{BoolMessage, StringMessage, StringPairMessage};
...
impl MetaCredentialServiceImpl {
    ...
    pub async fn meta_credential_list(
        ...
        let res = identities_idns_api::identity::IdnsMetaCredential::meta_credential_list(
            source_identity,
        )
        .await?;
        Ok(res)
    ...
    pub async fn query_one_meta_credential(
        ...
        let res = identities_idns_api::identity::IdnsMetaCredential::query_one_meta_credential(
            source_identity,
            name,
        )
        .await?;
    ...
    pub async fn create_meta_credential(
        ...
        let _ = identities_idns_api::identity::IdnsMetaCredential::create_meta_credential(request)
            .await?;
        Ok(true)
    }
    pub async fn remove_meta_credential(
        ...
        let _ = identities_idns_api::identity::IdnsMetaCredential::remove_meta_credential(
            source_identity,
            name,
        )
        .await?;
    ...
    pub async fn update_meta_credential(
        ...
        let _ = identities_idns_api::identity::IdnsMetaCredential::update_meta_credential(request)
            .await?;
        Ok(true)
    }
}
