...
import 'package:idns_wallet/widgets/BottomNavigationBar/bottom_curved_Painter.dart';
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                _icon(Icons.perm_identity, _selectedIndex == 1, 1),
                _icon(Icons.credit_score_outlined, _selectedIndex == 2, 2),
